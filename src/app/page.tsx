...
export default async function HomePage() {
  ...
  return (
    <section className="grid grid-cols-1 gap-4 md:grid-cols-2" aria-label="Articles">
      <article className="rounded-2xl border bg-(--surface) p-4 shadow border-(--border)">
        <h2 className="mb-2 text-lg font-semibold">Lorem ipsum dolor sit amet</h2>
        <p className="mb-3">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer at pulvinar justo. Sed id
          bibendum metus. In hac habitasse platea dictumst. In non malesuada justo. Aenean eget orci
          at lectus condimentum ultrices a nec arcu.
        </p>
        <p>
